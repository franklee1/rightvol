...
class CMainParams : public CChainParams
{
  public:
    CMainParams()
    {
        ...
        const char *pszTimestamp = "The final score of Feb 2018 righ one";
...
//        printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
  //     printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0x41f7cb73792a7465c97e83f40323b9b810481845ec203665d71c8c7a9fc50b60"));
        assert(genesis.hashMerkleRoot == uint256("0x47f3c68b2e946a1e2295ff5b02cda973e58306ca64aac87ff20092fbd090a37c"));
